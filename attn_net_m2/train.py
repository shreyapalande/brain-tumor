"""
train.py -- Baseline training for attn_net_m2

Trains an Attention U-Net with encoder CBAM (enc2/3/4) from random
initialisation.
...
Identical training procedure to attn_net_m1 -- only the model
architecture differs (CBAM at encoder vs. bottleneck).
...
def run_training(cfg: dict) -> None:
    ...
    log("=" * 80)
    log("Attention U-Net M2 (Encoder CBAM: enc2/3/4) -- Baseline Training")
...
def main() -> None:
    parser = argparse.ArgumentParser(
        description="Train Attention U-Net M2 (Encoder CBAM).")
